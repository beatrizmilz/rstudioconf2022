...
-   GitHub Actions has been heavily used in some contexts, like runing checks in packages, building the package website, and so on.
    Package developers can easily start using Acitons with the help of the package usethis and the function use_github_action(). There are several awesome examples in the r-lib/actions repository!
:::
